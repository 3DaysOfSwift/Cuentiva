                ...
                if viewModel.completed { PaywallView() }
                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 24) {
                            ...
                            Text("Cuentiva - little tales told by storytellers.").font(.system(.largeTitle, design: .serif, weight: .medium)).fixedSize(horizontal: false, vertical: true)
                            Text("Bring Spanish to life through a world of curious creatures and memorable tales.").font(.body).foregroundStyle(theme.theme.muted)
                            ...
                            Text("One complete book, free. Counts towards todays 3 books of recommended reading.").font(.footnote).frame(maxWidth: .infinity).multilineTextAlignment(.center)
