                ...
                if viewModel.completed { PaywallView() }
                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 24) {
                            ...
                            Text("Cuentiva - little tales told by storytellers. Begin a Spanish speaking journey today.").font(.system(.largeTitle, design: .serif, weight: .medium)).fixedSize(horizontal: false, vertical: true)
