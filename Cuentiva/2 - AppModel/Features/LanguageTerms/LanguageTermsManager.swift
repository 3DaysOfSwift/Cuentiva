...
@MainActor final class LanguageTermsManager: LanguageTermsFeature {
    ...
    private static let terms: [LanguageTerm] = [
        ...
        .init(id: "lemma", english: "Lemma", spanish: "Lema",
              ...
              explanation: "Imagine looking up walked in a dictionary. It may send you to walk. Why? Walked is a version of walk: it tells you the walking happened before now. Walks and walking are versions too.\n\nThe dictionary uses walk as the main heading for these versions. That heading form is called the lemma.\n\nIt gives us one place to look for the meaning instead of treating every version as an unrelated word.",
